#ifndef DMR_AMORTISMAN_FISI_H
#define DMR_AMORTISMAN_FISI_H
...
namespace Ui {
    class DMR_AMORTISMAN_FISI;
}

class DMR_AMORTISMAN_FISI : public FIS_KERNEL
...
public:
     ...
     DMR_AMORTISMAN_FISI                                                  (int, QWidget * parent = 0 );
    ~DMR_AMORTISMAN_FISI                                                  (){}

private:

    Ui::DMR_AMORTISMAN_FISI * m_ui;
