#ifndef PRS_PERSONEL_AILE_FISI_CLASS_H
#define PRS_PERSONEL_AILE_FISI_CLASS_H

#include <fis_kernel.h>
#include "ui_prs_personel_aile_fisi.h"

class PRS_PERSONEL_AILE_FISI : public FIS_KERNEL , public Ui::PRS_PERSONEL_AILE_FISI
...
public:
     ...
     PRS_PERSONEL_AILE_FISI               ( int, QWidget * parent = 0 );
    ~PRS_PERSONEL_AILE_FISI               (){}
...
#endif // PRS_PERSONEL_AILE_FISI_H
