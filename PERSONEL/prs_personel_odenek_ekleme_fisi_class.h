#ifndef PRS_PERSONEL_ODENEK_EKLEME_FISI_CLASS_H
#define PRS_PERSONEL_ODENEK_EKLEME_FISI_CLASS_H

#include <fis_kernel.h>
#include "ui_prs_personel_odenek_ekleme_fisi.h"

class PRS_PERSONEL_ODENEK_EKLEME_FISI : public FIS_KERNEL , public Ui::PRS_PERSONEL_ODENEK_EKLEME_FISI
...
public:
     ...
     PRS_PERSONEL_ODENEK_EKLEME_FISI               ( int who_called, int record_id, QWidget * parent = 0 );
    ~PRS_PERSONEL_ODENEK_EKLEME_FISI               (){}
...
#endif // PRS_PERSONEL_ODENEK_EKLEME_FISI_H
