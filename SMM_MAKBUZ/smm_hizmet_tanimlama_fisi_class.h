#ifndef SMM_HIZMET_TANIMLAMA_FISI_H
#define SMM_HIZMET_TANIMLAMA_FISI_H

#include <fis_kernel.h>
#include "ui_smm_hizmet_tanimlama_fisi.h"

namespace ui {
    class SMM_HIZMET_TANIMLAMA_FISI;
}

class SMM_HIZMET_TANIMLAMA_FISI : public FIS_KERNEL
...
public:
     ...
     SMM_HIZMET_TANIMLAMA_FISI                                                  ( int sube_id,int hizmet_sekli,QWidget * parent = 0 );
    ~SMM_HIZMET_TANIMLAMA_FISI                                                  (){}

private:

    Ui::SMM_HIZMET_TANIMLAMA_FISI   *        m_ui;
    int                     m_sube_id;
    int                     m_hizmet_sekli;
...
#endif // SMM_HIZMET_TANIMLAMA_FISI_H
